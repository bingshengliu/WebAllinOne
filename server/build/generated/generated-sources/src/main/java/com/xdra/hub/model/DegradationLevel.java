...
public enum DegradationLevel {
  ...
  @JsonCreator
  public static DegradationLevel fromValue(String value) {
    for (DegradationLevel b : DegradationLevel.values()) {
